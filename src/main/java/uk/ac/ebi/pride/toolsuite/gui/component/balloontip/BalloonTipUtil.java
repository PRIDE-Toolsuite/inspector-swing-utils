 ...
 * @version $Id$
 */
public final class BalloonTipUtil {
     ...
     * @param message   message to display
     */
    public static BalloonTip createBalloonNote(JComponent component, Icon icon, String message, BalloonTip.AttachLocation location, int horizontalOffeset, int verticalOffset, boolean closeButton) {
        JLabel label = new JLabel(message);
        if(icon != null)
            label.setIcon(icon);
        return createBalloonTip(component, label, NOTE_FILL_COLOUR, BalloonTip.Orientation.LEFT_ABOVE, location, horizontalOffeset, verticalOffset, closeButton);
    }
    ...
    public static BalloonTip createBalloonTip(JComponent component, JComponent contents, Color fillColour,
                                              BalloonTip.Orientation orientation, BalloonTip.AttachLocation attachLocation, int horizontalOffeset, int verticalOffset, boolean closeButton) {
        BalloonTipStyle tipStyle = new RoundedBalloonStyle(MESSAGE_ARC_WIDTH, MESSAGE_ARC_HEIGHT,
                fillColour, MESSAGE_BORDER_COLOR);
        return new BalloonTip(component, contents, tipStyle, orientation, attachLocation, horizontalOffeset, verticalOffset, closeButton);
    }
